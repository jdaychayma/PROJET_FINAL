...
const AppNavBar = () => {
  ...
  return (
    <div>
      <Navbar expand="sm" >
        <NavbarBrand href="/"><img id='imgnav' src="https://www.pngfind.com/pngs/m/29-290389_e-commerce-website-logo-png-download-e-commerce.png"></img></NavbarBrand>
